...
install_style () {
	...
	{ mkdir $PREFIX/share/TERMUX-MASTER; cp -r $DIR/colors $PREFIX/share/TERMUX-MASTER; cp -r $DIR/fonts $PREFIX/share/TERMUX-MASTER; cp -r $DIR/style $PREFIX/share/TERMUX-MASTER; }
